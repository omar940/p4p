...
#    ax1.grid(color='b', linestyle='-', linewidth=.05)
    ...
    for i in range(1,n+1):
        ...
        if df.loc[i,'Site_Rate_U95'] < ECF_mean:
        ...
        elif df.loc[i,'Site_Rate_L95'] > ECF_mean:
...
#    plt.yticks(np.arange(1,n+1), df.index, fontsize=6)
...
#    ax1.legend(handles=[collab_line1, better, middle, worse], loc=0)
